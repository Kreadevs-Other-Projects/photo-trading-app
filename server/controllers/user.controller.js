...
const sendEmail = async (req, res) => {
  ...
  try {
    const checkUser = await pool.query(
      "SELECT * FROM wait_list_email WHERE email = $1",
      [email]
    );
    ...
    await pool.query("INSERT INTO wait_list_email (email) VALUES ($1)", [
      email,
    ]);
    ...
    const mailOptions = {
      ...
      html: `<div style="background: linear-gradient(135deg, hsl(214, 100%, 50%) 0%, hsl(280, 65%, 60%) 100%); padding: 40px 20px; font-family: 'Arial', sans-serif; color: #333;">
...
//           <h2 style="color: hsl(214, 100%, 50%); margin: 0 0 20px; font-size: 28px;">
//             Get Ready to Trade Moments!
//           </h2>
...
//             <a href="#" style="display: inline-block; background: linear-gradient(135deg, hsl(214, 100%, 50%) 0%, hsl(280, 65%, 60%) 100%); color: white; padding: 12px 30px; border-radius: 25px; text-decoration: none; font-weight: bold; font-size: 16px;">
//               📣 Share the News
//             </a>
//           </div>
//         </td>
...
//           <p style="margin: 0 0 15px; font-size: 16px; opacity: 0.9;">
