...
const ProcessingAnimation = ({ stage, isProcessing }) => {
...
//                                   {/* Main cloud icon */}
//                                   <motion.div
//                                     className="w-14 h-14 bg-white rounded-full flex items-center justify-center shadow-lg border border-blue-200"
//                                     animate={{
//                                       scale: [1, 1.05, 1],
//                                       y: [0, -2, 0],
//                                     }}
